...
def EfficientNetB0(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.0, 1.0, None, 0.2,
...
def EfficientNetB1(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.0, 1.1, None, 0.2,
...
def EfficientNetB2(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.1, 1.2, None, 0.3,
...
def EfficientNetB3(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.2, 1.4, None, 0.3,
...
def EfficientNetB4(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.4, 1.8, None, 0.4,
...
def EfficientNetB5(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.6, 2.2, None, 0.4,
...
def EfficientNetB6(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(1.8, 2.6, None, 0.5,
...
def EfficientNetB7(include_top=True,
                   ...
                   classes=1000,
                   **kwargs):
    return EfficientNet(2.0, 3.1, None, 0.5,
